...
class DiscoverScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //without the null checks it tries to rebuild twice and produces an error
    //set default custom tab number to 2 on page load
    if (Provider.of<AppData>(context).customTabSelected == null)
      Provider.of<AppData>(context).setCustomTabSelected(tabNumber: 2);
    ...
    return FutureProvider.value(
      value: Provider.of<CloudDB>(context).streamCommunication(),
