            ...
            builder: (BuildContext context) {
              return DialogConfirm(
                ...
                onPressed: () async {
                  ...
                  String plantID = Provider.of<AppData>(context, listen: false)
                      .forwardingPlantID;
                  ...
                  if (imageIsThumb == true) {
                    //new data map
                    Map<String, dynamic> thumbData = {PlantKeys.thumbnail: ''};
                              ...
                              showDialog(
                                ...
                                builder: (BuildContext context) {
                                  return DialogConfirm(
                                    ...
                                    text:
                                        'Would you like to use this image as the plant thumbnail image?',
                                    onPressed: () {
                                      if (connectionLibrary == false) {
